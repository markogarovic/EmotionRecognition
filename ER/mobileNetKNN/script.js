...
function changeState(e){
  ...
  if(currentState != radio.value){
    if(radio.value == 0){
      document.querySelector(".custom-classifer-container").classList.add("hidden");
      document.querySelector(".KNN-container").classList.remove("hidden");
      currentState = 0;
    }else{
      document.querySelector(".KNN-container").classList.add("hidden");
      document.querySelector(".custom-classifer-container").classList.remove("hidden");
      currentState = 1;
    }
  }
}
...
document.querySelector(".classifer-select").addEventListener("click", changeState);
app(); 
